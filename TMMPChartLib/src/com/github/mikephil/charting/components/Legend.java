...
public class Legend extends ComponentBase {
    ...
    /** the space that should be left between stacked forms */
    private List<Integer> showDottedlinesOn = new ArrayList<Integer>();
    ...
    public void showDottedlinesOn(List<Integer> positions) {
    	showDottedlinesOn = positions;
    }
    public List<Integer> getShowDottedlinesOn() {
    	return showDottedlinesOn;
    }
    /**
