...
public class LegendRenderer extends Renderer {
    ...
    protected Paint mLegendDotedFormPaint;
    ...
    public LegendRenderer(ViewPortHandler viewPortHandler, Legend legend) {
        ...
        mLegendDotedFormPaint = new Paint();
        mLegendDotedFormPaint.setStyle(Paint.Style.STROKE);
        mLegendDotedFormPaint.setStrokeWidth(3f);
        mLegendDotedFormPaint.setPathEffect(new DashPathEffect(new float[]{1, 1, 1, 2}, 0));
        mLegendDotedFormPaint.setAlpha(120); 
        
        mLegendFormPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mLegendFormPaint.setStyle(Paint.Style.FILL);
        mLegendFormPaint.setStrokeWidth(5f);
        mLegendFormPaint.setStyle(Style.STROKE);
        mLegendFormPaint.setPathEffect(new DashPathEffect(new float[] {10,20}, 0));
    }
    ...
    protected void drawForm(Canvas c, float x, float y, int index, Legend legend) {
        ...
        mLegendDotedFormPaint.setColor(legend.getColors()[index]);
        ...
        switch (legend.getForm()) {
            ...
            case SQUARE:
                ...
                break;
            case LINE:
            	if (legend.getShowDottedlinesOn().contains(index))
				{
            	
				int divider = (int) (formsize/7);
				int gap = 4;
				float start = x;
				float startend = x+divider;
				while(start < (formsize+x))
				{
					if (startend> (formsize+x))
					{
						startend = formsize+x;
					}
					c.drawLine(start, y, startend , y, mLegendDotedFormPaint);
					start = startend + gap;
					startend = start + divider;
				}
