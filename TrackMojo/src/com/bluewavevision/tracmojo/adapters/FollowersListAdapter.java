...
import com.bluewavevision.tracmojo.ui.GroupTracEditInviteFollowersActivity;
import com.bluewavevision.tracmojo.ui.PersonalTracEditInviteFollowersActivity;
...
public class FollowersListAdapter extends BaseAdapter {
	...
	public FollowersListAdapter(Context con, ArrayList<Follower> contacts,boolean isGroup) {
        ...
        new AlertDialog.Builder(mContext)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(isGroup)
                            ((GroupTracEditInviteFollowersActivity)mContext).deleteFollowers(position);
                        else
                            ((PersonalTracEditInviteFollowersActivity)mContext).deleteFollowers(position);
                    }
                })
