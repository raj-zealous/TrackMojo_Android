...
import com.bluewavevision.tracmojo.ui.GroupTracEditInviteParticipantsActivity;
...
public class ParticipantsListAdapter extends BaseAdapter {
	...
	public ParticipantsListAdapter(Context con, ArrayList<Follower> contacts) {
        ...
        new AlertDialog.Builder(mContext)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ((GroupTracEditInviteParticipantsActivity)mContext).deleteParticipants(position);
                    }
                })
