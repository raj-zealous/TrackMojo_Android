...
import com.bluewavevision.tracmojo.ui.AddParticipantsActivity;
...
public class ParticipantsListForAddAdapter extends BaseAdapter {
	...
	public ParticipantsListForAddAdapter(Context con, ArrayList<Follower> contacts) {
    ...
    public void showDeleteConfirmationDialog(final int position){
        new AlertDialog.Builder(mContext)
                .setTitle(mContext.getString(R.string.delete_participants_dialog_title))
                .setMessage(mContext.getString(R.string.delete_participants_dialog_message))
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        // continue with delete
                        ((AddParticipantsActivity)mContext).deleteParticipants(position);
                    }
                })
