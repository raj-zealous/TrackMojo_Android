...
public class TracIdeaAdapter extends BaseAdapter  {

	Context con;
	List<RateIdea> itemList;
	...
	public TracIdeaAdapter(Context c, ArrayList<RateIdea> list, int defaultPosition) {
	...
	public RateIdea getItemFromList(int position)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        RateIdea rateIdea = itemList.get(position);
