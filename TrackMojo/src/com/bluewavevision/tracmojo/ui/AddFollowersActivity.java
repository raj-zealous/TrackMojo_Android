...
import com.bluewavevision.tracmojo.adapters.FollowersListForAddAdapter;
...
public class AddFollowersActivity extends BaseActivity {
	...
	private void initializeComponents() {
		...
		tvNoFollowerFound = (TextView) findViewById(
				R.id.activity_personal_trac_edit_invite_followers_tvNoFollowerFound);
		...
		relInviteMoreFriends = (RelativeLayout) findViewById(
				R.id.activity_personal_trac_edit_invite_followers_relInviteViaEmail);
	...
	private void editPersonalTrac() {
		...
		VolleyStringRequest editPersonalTracRequest = new VolleyStringRequest(Request.Method.POST,
				Webservices.ADD_FOLLOWERS, editPersonalTracSuccessLisner(), editPersonalTracErrorLisner()) {
			...
			protected Map<String, String> getParams() throws com.android.volley.AuthFailureError {
				...
				Log.i("", "ADD_FOLLOWERS user_id=" + preferences.getInt("userid", -1));
				Log.i("", "ADD_FOLLOWERS trac_id=" + tracId);
				Log.i("", "ADD_FOLLOWERS invited_emails=" + selectedContacts);
				Log.i("", "ADD_FOLLOWERS invited_names=" + selectedContactsName);
