...
import com.bluewavevision.tracmojo.adapters.FollowersListAdapter;
...
public class GroupTracEditInviteFollowersActivity extends BaseActivity {

    private final int REQUEST_FOR_CONTACT_SELECTION = 0x123;

    private Context mContext;
    private EditText etTracName;
    private TextView tvInviteViaMail,tvBack,tvDone,tvGroupName,tvNoFollwerFound;;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_trac_edt_invite_followers);
    ...
    private void initializeComponents() {
        ...
        tvNoFollwerFound = (TextView) findViewById(R.id.activity_group_trac_edit_invite_followers_tvNoFollowerFound);

        etTracName = (EditText) findViewById(R.id.activity_group_trac_edit_invite_followers_etTracName);
        lvFollowersList = (ListView) findViewById(R.id.activity_group_trac_edit_invite_followers_lvFollowersList);
        tvInviteViaMail = (TextView) findViewById(R.id.activity_group_trac_edit_invite_followers_tvInviteViaMail);
        tvGroupName = (TextView) findViewById(R.id.activity_group_trac_edit_invite_followers_tvGroupName);

        relInviteMoreFriends = (RelativeLayout) findViewById(R.id.activity_group_trac_edit_invite_followers_relInviteViaEmail);
        relInviteMoreFriends.setOnClickListener(this);

        tvBack = (TextView) findViewById(R.id.activity_group_trac_edit_invite_followers_tvBack);
        tvDone = (TextView) findViewById(R.id.activity_group_trac_edit_invite_followers_tvDone);
    ...
    private void setDataFromPreviousScreen() throws JSONException {
        ...
        if(intent!=null) {
            ...
            if(listFollowers!=null) {
                adapter = new FollowersListAdapter(mContext, listFollowers,true);
    ...
    public void onClick(View v) {
        super.onClick(v);
        switch (v.getId()) {
            case R.id.activity_group_trac_edit_invite_followers_relInviteViaEmail:
                goToContactSelectionScreen();
                break;

            case R.id.activity_group_trac_edit_invite_followers_tvBack:
                onBackPressed();
                break;

            case R.id.activity_group_trac_edit_invite_followers_tvDone:
    ...
    private void editGroupTrac() {

        VolleyStringRequest editGroupTracRequest = new VolleyStringRequest(
                Request.Method.POST, Webservices.EDIT_GROUP_TRAC,
                editGroupTracSuccessLisner(), editGroupTracErrorLisner()) {
        ...
        showProgress();
        mQueue.add(editGroupTracRequest);
    }

    private com.android.volley.Response.Listener<String> editGroupTracSuccessLisner() {
    ...
    private com.android.volley.Response.ErrorListener editGroupTracErrorLisner() {
