...
public class PersonalTracAddActivity extends BaseActivity implements View.OnFocusChangeListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_trac_add);
    ...
    private void initializeComponents(){
        ...
        etCustomTracWording1 = (EditText) findViewById(R.id.activity_add_personal_trac_etCustomTracWord1);
        etCustomTracWording2 = (EditText) findViewById(R.id.activity_add_personal_trac_etCustomTracWord2);
        etCustomTracWording3 = (EditText) findViewById(R.id.activity_add_personal_trac_etCustomTracWord3);
        etCustomTracWording4 = (EditText) findViewById(R.id.activity_add_personal_trac_etCustomTracWord4);
        etCustomTracWording5 = (EditText) findViewById(R.id.activity_add_personal_trac_etCustomTracWord5);

        etTracName = (EditText) findViewById(R.id.activity_add_personal_trac_etTracName);

        tvBack = (TextView) findViewById(R.id.activity_add_personal_trac_tvBack);
        tvNext = (TextView) findViewById(R.id.activity_add_personal_trac_tvNext);
        tvChooseTracIdeas = (TextView) findViewById(R.id.activity_add_personal_trac_tvChooseTracIdeas);
        tvChooseTracWordings = (TextView) findViewById(R.id.activity_add_personal_trac_tvChooseTracWordings);
    ...
    public void onClick(View v) {
        super.onClick(v);
        switch (v.getId()){
            case R.id.activity_add_personal_trac_tvChooseTracIdeas:
                if(listRateIdea!=null && listRateIdea.size()>0)
                showTracIdeaDialog();
                break;

            case R.id.activity_add_personal_trac_tvChooseTracWordings:
                if(listRateWord!=null && listRateWord.size()>0)
                    showTracRateWordingsDialog();
                break;

            case R.id.activity_add_personal_trac_tvBack:
                onBackPressed();
                break;

            case R.id.activity_add_personal_trac_tvNext:
            ...
            case R.id.activity_add_personal_trac_etTracName:
                defaultTracIdeaId = 0;
                tvChooseTracIdeas.setText("");

                break;

            case R.id.activity_add_personal_trac_etCustomTracWord1:
                defaultRateWordId = 0;
                tvChooseTracWordings.setText("");
                break;

            case R.id.activity_add_personal_trac_etCustomTracWord2:
                defaultRateWordId = 0;
                tvChooseTracWordings.setText("");
                break;

            case R.id.activity_add_personal_trac_etCustomTracWord3:
                defaultRateWordId = 0;
                tvChooseTracWordings.setText("");
                break;

            case R.id.activity_add_personal_trac_etCustomTracWord4:
                defaultRateWordId = 0;
                tvChooseTracWordings.setText("");
                break;

            case R.id.activity_add_personal_trac_etCustomTracWord5:
                defaultRateWordId = 0;
                tvChooseTracWordings.setText("");
                break;
            default:
    ...
    private void goToSetFrequencyScreen(){
        Intent intent = new Intent(mContext,PersonalTracSetFrequencyActivity.class);
