...
import com.tracmojo.adapters.ManageTracExpandableListAdapter;
import com.tracmojo.backgroundservices.DownloadResultReceiver;
import com.tracmojo.backgroundservices.DownloadService;
import com.tracmojo.database.RemDBAdapter;
import com.tracmojo.database.RemDBHelper;
import com.tracmojo.model.RateColor;
...
public class EditTracFragment extends BaseFragment implements OnClickListener, TracRateFragment.Updateable, DownloadResultReceiver.Receiver {
    ...
    private int parentPosition, childPosition, tracid;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mContext.ivBack.setVisibility(View.INVISIBLE);
        mContext.ivInfo.setVisibility(View.VISIBLE);
        ...
        if (llLayout == null) {
            ...
            listDataHeader.add(getString(R.string.edit_tab_manage_my_tracs));
            listDataHeader.add(getString(R.string.edit_tab_manage_group_tracs));
            listDataHeader.add(getString(R.string.edit_tab_manage_followed_tracs));
            ...
            expListView.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {
                ...
                public void onGroupExpand(int groupPosition) {
                    ...
                    prefs.edit().putInt("groupPositionEdit",expandedGroupPosition).apply();
...
//        }
    ...
    private void getTracListInOffline() {
        ...
        try {
            ...
            listAdapter = new ManageTracExpandableListAdapter(mContext, listDataHeader, listDataChild);
            ...
            public void onResponse(String arg0) {
                ...
                try {
                    ...
                    if (jsonObject != null) {
                        ...
                        if(prefs.getInt("groupPositionEdit",-1)!=-1){
                            expListView.expandGroup(prefs.getInt("groupPositionEdit",0));
                        } else {
    ...
    //For the deleting the trac
    public void deleteRate(final String tracid, int parentPosition, int childPosition) {

        this.parentPosition = parentPosition;
        this.childPosition = childPosition;
        this.tracid = Integer.parseInt(tracid);

        VolleyStringRequest deleteRateRequest = new VolleyStringRequest(
                Request.Method.POST, Webservices.DELETE_TRAC,
                deleteRateSuccessLisner(), errorLisner()) {
        ...
        showProgress();
        mQueue.add(deleteRateRequest);
    }

    private com.android.volley.Response.Listener<String> deleteRateSuccessLisner() {
        return new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String arg0) {
                ...
                try {
                    ...
                    if (jsonObject != null) {
                        ...
                        remDBAdapter = new RemDBAdapter(mContext);
                        remDBAdapter.open();
                        remDBAdapter.deleteTrac(tracid);
                        remDBAdapter.close();

                        String msg = "" + jsonObject.getString("message");
                        Util.showMessage(mContext, msg);
                        deleteTracAndNotify();
                        /*HomeFragment fragment = (HomeFragment) ((DashboardActivity)mContext).mStacks.get(Util.TAB_HOME).get(0);
                        if(fragment!=null)
                        fragment.refreshTracList(parentPosition, childPosition);*/
                    }
                } catch (JSONException e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
    ...
    private void deleteTracAndNotify() {
    ...
    public interface RefreshTracList {
        public void refreshTracList(int parentPosition, int childPosition);
    }

    //For the deleting the trac
    public void respondToInvitation(final String tracid, int parentPosition, int childPosition,
        ...
        VolleyStringRequest respondToInvitationRequest = new VolleyStringRequest(
                Request.Method.POST, Webservices.RESPOND_TO_INVITATION,
                respondToInvitationSuccessLisner(), errorLisner()) {
        ...
        showProgress();
        mQueue.add(respondToInvitationRequest);
    }

    private com.android.volley.Response.Listener<String> respondToInvitationSuccessLisner() {
        return new com.android.volley.Response.Listener<String>() {
            ...
            public void onResponse(String arg0) {
                ...
                try {
                    ...
                    if (jsonObject != null) {
                        ...
                        String msg = "" + jsonObject.getString("message");
                        Util.showMessage(mContext, msg);
                        Trac mTrac = listDataChild.get(listDataHeader.get(parentPosition)).get(childPosition);
                        mTrac.setRequestStatus(requestStatus);
                        listDataChild.get(listDataHeader.get(parentPosition)).set(childPosition, mTrac);
                        listAdapter.notifyDataSetChanged();
                        if (requestStatus.equalsIgnoreCase("d"))
                            deleteTracAndNotify();
                        /*HomeFragment fragment = (HomeFragment) ((DashboardActivity)mContext).mStacks.get(Util.TAB_HOME).get(0);
                        fragment.refreshTracList(parentPosition, childPosition);*/
                    }
