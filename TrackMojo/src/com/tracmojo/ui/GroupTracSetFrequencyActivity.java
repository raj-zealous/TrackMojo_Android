...
public class GroupTracSetFrequencyActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_trac_set_frequency);
    ...
    private void initializeComponents(){
        ...
        etTracName = (EditText) findViewById(R.id.activity_group_set_frequency_etTracName);

        tvGroupName = (TextView) findViewById(R.id.activity_group_set_frequency_tvGroupName);
        tvParentFrequency = (TextView) findViewById(R.id.activity_group_set_frequency_tvParentFrequency);
        tvChildFrequency = (TextView) findViewById(R.id.activity_group_set_frequency_tvChildFrequency);
        tvChildFrequencyLabel = (TextView) findViewById(R.id.activity_group_set_frequency_tvChildFrequencyLabel);
        tvFinishDate = (TextView) findViewById(R.id.activity_group_set_frequency_tvFinishingDate);
        tvBack = (TextView) findViewById(R.id.activity_group_set_frequency_tvBack);
        tvNext = (TextView) findViewById(R.id.activity_group_set_frequency_tvNext);
    ...
    public void onClick(View v) {
        super.onClick(v);
        switch (v.getId()){
            case R.id.activity_group_set_frequency_tvParentFrequency:
                showParentFrequencyDialog();
                break;

            case R.id.activity_group_set_frequency_tvChildFrequency:
                if(!TextUtils.isEmpty(defaultParentFrequency)){
                    showChildFrequencyDialog();
                }
                break;

            case R.id.activity_group_set_frequency_tvFinishingDate:
                showCustomDatePickerDialog();
                break;

            case R.id.activity_group_set_frequency_tvBack:
                onBackPressed();
                break;

            case R.id.activity_group_set_frequency_tvNext:
    ...
    private void goToInviteParticipantsScreen(){
        Intent intent = new Intent(mContext,GroupTracInviteParticipantsActivity.class);
        ...
        lvRangelist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(rateFrequencyList.get(defaultParentFrequency)==null){
                    ...
                    tvChildFrequency.setOnClickListener(GroupTracSetFrequencyActivity.this);
                }
