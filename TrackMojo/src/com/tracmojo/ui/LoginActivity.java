...
import com.tracmojo.twitter.Twitt_Sharing;
import com.tracmojo.twitter.TwitterSession;
...
public class LoginActivity extends Activity implements OnClickListener,GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        twitter = new Twitt_Sharing(LoginActivity.this, TwitterSession.TWEET_AUTH_KEY, TwitterSession.TWEET_AUTH_SECRET_KEY,TwitterSession.TWITTER_CONSUMER_CALLBACK);
    ...
    private void login() {
        ...
        VolleyStringRequest loginRequest = new VolleyStringRequest(
                Method.POST, Webservices.LOGIN,
                loginSuccessLisner(), loginErrorLisner()) {
    ...
    private void forgotPassword(final String email) {
        VolleyStringRequest forgotPasswordRequest = new VolleyStringRequest(
                Method.POST, Webservices.FORGOT_PASSWORD,
