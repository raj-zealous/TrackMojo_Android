...
public class PersonalTracEditSetFrequencyActivity extends BaseActivity {

    private static final int  REQUEST_TO_DELETE_CONTACT = 0x123;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_trac_edit_set_frequency);
    ...
    private void initializeComponents(){
        ...
        etTracName = (EditText) findViewById(R.id.activity_personal_trac_edit_set_frequency_etTracName);

        tvGroupName = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvGroupName);
        tvParentFrequency = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvParentFrequency);
        tvChildFrequency = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvChildFrequency);
        tvChildFrequencyLabel = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvChildFrequencyLabel);
        tvFinishDate = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvFinishingDate);
        tvBack = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvBack);
        tvNext = (TextView) findViewById(R.id.activity_personal_trac_edit_set_frequency_tvNext);
    ...
    public void onClick(View v) {
        super.onClick(v);
        switch (v.getId()){
            case R.id.activity_personal_trac_edit_set_frequency_tvParentFrequency:
                showParentFrequencyDialog();
                break;

            case R.id.activity_personal_trac_edit_set_frequency_tvChildFrequency:
                if(!TextUtils.isEmpty(defaultParentFrequency)){
                    showChildFrequencyDialog();
                }
                break;

            case R.id.activity_personal_trac_edit_set_frequency_tvFinishingDate:
                showCustomDatePickerDialog();
                break;

            case R.id.activity_personal_trac_edit_set_frequency_tvBack:
                onBackPressed();
                break;

            case R.id.activity_personal_trac_edit_set_frequency_tvNext:
    ...
    private void goToInviteFollowersScreen(){
        Intent intent = new Intent(mContext,PersonalTracEditInviteFollowersActivity.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == REQUEST_TO_DELETE_CONTACT){
            if(resultCode == RESULT_OK){
                listFollowers = (ArrayList<Follower>) data.getSerializableExtra("followersList");
            }
        }
    }*/
